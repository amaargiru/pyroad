...
(-) В подраздел "git" добавить 3-5 основных команд.  
(-) Подраздел "Linux" разбить на подразделы в соответствии с курсом "Введение в Linux" на Stepik. Часть разделов пометить зеленым.  
(-) В "Language Skeleton" после "Exception" добавить подраздел "Typing" с подразделами "typing", "Protocol", "final (name mangling)", "Literal", "TypedDict".  
